    ...
    >
      <div className="relative aspect-square overflow-hidden rounded-t-2xl">
        ...
        <div className="absolute top-3 right-3 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">
          <Badge variant="secondary" className="text-lg px-3 py-1 shadow-soft backdrop-blur-sm">
            {CATEGORY_ICONS[toy.category]}
          </Badge>
        </div>
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-foreground/70 via-foreground/30 to-transparent p-4 transition-all duration-300 group-hover:from-foreground/80">
